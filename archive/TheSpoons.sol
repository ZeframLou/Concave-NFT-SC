...
contract TheSpoons is ERC721Enumerable, Ownable {
    ...
    */
    function mintSpiral(uint256 tokenId) public {
        ...
        require(!hasClaimed[tokenId], "Color has already claimed their Spoon.");
        require(msg.sender == tokenOwner, "Only token owner can mint their Spoon.");
    ...
    */
    ...
    function generateNameDescription(uint256 tokenId) internal view returns (string memory) {
        ...
        return string(
            abi.encodePacked(
                ...
                unicode'"description":"The Spoons',
                '\\nToken id: #',
                tokenId.toString(),
                '",',
                '"name":"The ',
    ...
    function generateSVGImage(uint256 tokenId) internal view returns (string memory) {
      ...
      return ITheSpoonsSVG(THE_SPOONS_SVG).generateSVGImage(tokenId,hexCode,role,opposite,r,g,b,traits.material);
    }
